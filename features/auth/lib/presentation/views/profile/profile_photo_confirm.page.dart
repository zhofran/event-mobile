...
@RoutePage()
class ProfilePhotoConfirmPage extends StatefulWidget {
  const ProfilePhotoConfirmPage({required this.onResult, super.key});

  final Function(bool didChange) onResult;

  @override
  State<ProfilePhotoConfirmPage> createState() => _ProfilePhotoConfirmPageState();
}

class _ProfilePhotoConfirmPageState extends State<ProfilePhotoConfirmPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: _buildProfilePhotoConfirmContent(),
                    ),
                    // Bottom Buttons
                    _buildBottomButtons(),
                    PaddingGap.lg(),
  ...
  Widget _buildProfilePhotoConfirmContent() {
    return Column(
      children: [
        PaddingGap.lg(),
        ...
        FabTextStyled(
          'That’s a fantastic photo people will remember you for sure!',

...
import '../../domain/models/event_item.model.dart';

part 'event.cubit.freezed.dart';
part 'states/event.state.dart';

@lazySingleton
class EventCubit extends Cubit<EventState> {
  EventCubit(this._client) : super(EventState.initial());
  ...
  void increaseQuantity(int id) {
    ...
    final newCartItems = List<EventItemModel>.from(state.cartItems);

...
@RoutePage()
class JobAppliedDetailsPage extends StatefulWidget {
  const JobAppliedDetailsPage({
  ...
  @override
  State<JobAppliedDetailsPage> createState() => _JobAppliedDetailsPageState();
}

class _JobAppliedDetailsPageState extends State<JobAppliedDetailsPage> {
  @override

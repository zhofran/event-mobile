...
@RoutePage()
class DiscoverDetailsPage extends StatefulWidget {
  ...
  @override
  State<DiscoverDetailsPage> createState() => _DiscoverDetailsPageState();
}

class _DiscoverDetailsPageState extends State<DiscoverDetailsPage> {
